#!/usr/bin/env python3
"""
Test the actual API endpoint with the user's payload
"""
import requests
import json
...
payload = {
    ...
    "payload": {
        ...
        "data": {
            ...
            "ar_grama_niladhari_division_ownership": "අළුත්කඩේ  නැගෙනහිර / Aluthkade East / புதుக்கடை கிழக்கு",
...
try:
    ...
    response = requests.post(
        "http://localhost:8001/api/v1/arama-data/manage",
        json=payload,
