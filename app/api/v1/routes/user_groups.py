...
@router.post("/add", response_model=UserGroupOut)
...
@router.put("/update/{user_id}/{group_id}", response_model=UserGroupOut)
...
@router.delete("/remove/{user_id}/{group_id}", response_model=UserGroupOut)
