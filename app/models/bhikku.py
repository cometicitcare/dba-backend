...
class Bhikku(Base):
    ...
    province_rel = relationship("Province", primaryjoin="foreign(Bhikku.br_province) == Province.cp_code", viewonly=True, lazy="select")
    district_rel = relationship("District", primaryjoin="foreign(Bhikku.br_district) == District.dd_dcode", viewonly=True, lazy="select")
    division_rel = relationship("DivisionalSecretariat", primaryjoin="foreign(Bhikku.br_division) == DivisionalSecretariat.dv_dvcode", viewonly=True, lazy="select")
    gndiv_rel = relationship("Gramasewaka", primaryjoin="foreign(Bhikku.br_gndiv) == Gramasewaka.gn_gnc", viewonly=True, lazy="select")
    status_rel = relationship("StatusData", primaryjoin="foreign(Bhikku.br_currstat) == StatusData.st_statcd", viewonly=True, lazy="select")
    parshawaya_rel = relationship("ParshawaData", primaryjoin="foreign(Bhikku.br_parshawaya) == ParshawaData.pr_prn", viewonly=True, lazy="select")
    livtemple_rel = relationship("ViharaData", primaryjoin="foreign(Bhikku.br_livtemple) == ViharaData.vh_trn", viewonly=True, lazy="select")
    mahanatemple_rel = relationship("ViharaData", primaryjoin="foreign(Bhikku.br_mahanatemple) == ViharaData.vh_trn", viewonly=True, lazy="select")
    mahanaacharyacd_rel = relationship("Bhikku", primaryjoin="foreign(Bhikku.br_mahanaacharyacd) == remote(Bhikku.br_regn)", viewonly=True, lazy="select")
    category_rel = relationship("BhikkuCategory", primaryjoin="foreign(Bhikku.br_cat) == BhikkuCategory.cc_code", viewonly=True, lazy="select")
    viharadhipathi_rel = relationship("Bhikku", primaryjoin="foreign(Bhikku.br_viharadhipathi) == remote(Bhikku.br_regn)", viewonly=True, lazy="select")
    nikaya_rel = relationship("NikayaData", primaryjoin="foreign(Bhikku.br_nikaya) == NikayaData.nk_nkn", viewonly=True, lazy="select")
    mahanayaka_rel = relationship("Bhikku", primaryjoin="foreign(Bhikku.br_mahanayaka_name) == remote(Bhikku.br_regn)", viewonly=True, lazy="select")
    robing_tutor_residence_rel = relationship("ViharaData", primaryjoin="foreign(Bhikku.br_robing_tutor_residence) == ViharaData.vh_trn", viewonly=True, lazy="select")
    robing_after_residence_temple_rel = relationship("ViharaData", primaryjoin="foreign(Bhikku.br_robing_after_residence_temple) == ViharaData.vh_trn", viewonly=True, lazy="select")
