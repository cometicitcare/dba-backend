...
class AramaData(Base):
    ...
    ar_pradeshya_sabha = Column(String(100), ForeignKey("cmm_sasanarbm.sr_ssbmcode"))
    ...
    pradeshya_sabha_ref = relationship("SasanarakshakaBalaMandalaya", foreign_keys=[ar_pradeshya_sabha])
