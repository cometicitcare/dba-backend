...
class TempleLand(Base):
    """Temple owned land records associated with vihara"""
    __tablename__ = "temple_land"
    ...
    # Relationship
    vihara = relationship("ViharaData", back_populates="temple_lands")
